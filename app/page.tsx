        ...
        <div className="mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
            {featuredUnits.map((unit) => (
              <article
                key={unit.id}
                className="group overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_-20px_rgba(15,23,42,0.22)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_25px_80px_-18px_rgba(15,23,42,0.28)]"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex gap-3">
                    <Link
                      ...
                      className="inline-flex flex-1 items-center justify-center rounded-full border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50"
                    >
                      Detalji
                    </Link>
